...
```{r assign_B08Ia_mfa_I, echo=FALSE, results='asis'}
if (exists("assignment"))
  assignment("B08Ia_mfa", part = "I",
    url = "https://github.com/BioDataScience-Course/B08Ia_mfa",
    course.ids = c(
      'S-BIOG-015' = "B08Ia_21M_mfa", 
      'S-BIOG-937-958-959' = "B08Ia_21C_mfa"),
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/...", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-015' = !"{W[28]+1} 15:00:00"),
    course.ends = c(
      'S-BIOG-015' = !"{W[32]+5} 23:59:59"),
    term = "Q2", level = 3,
    toc = "Analyse factorielle multiple sur la présence d'oiseaux dans les Alpes françaises.")
```
...
- des metadonnées riches (y compris un dictionnaire des données^[Vous avez déjà rédigé un dictionnaire des données lorsque vous avez planifié vos mesures concernant la biométrie humaine l'an dernier au cours de science des données biologiques I.]),
...
```{r assign_B08Ia_mfa_II, echo=FALSE, results='asis'}
if (exists("assignment"))
    assignment("B08Ia_mfa", part = "II",
    url = "https://github.com/BioDataScience-Course/B08Ia_mfa",
    course.ids = c(
      'S-BIOG-015' = "B08Ia_21M_mfa", 
      'S-BIOG-937-958-959' = "B08Ia_21C_mfa"),
...
Ce module 8 vous a permis de découvrir l'AFM, les indices courants en écologie et l'Open Data. 
