...
if (exists("assignment"))
  assignment("B02Ia_anscombe", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-015' = "B02Ia_21M_anscombe", 
      'S-BIOG-937-958-959' = "B02Ia_21C_anscombe"),
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/niVlWfpm", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-015' = "2021-11-03 13:00:00"),
    course.ends = c(
      'S-BIOG-015' = "2021-11-19 23:59:59"),
...
if (exists("assignment"))
  assignment("B02Ib_achatina", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-015' = "B02Ib_21M_achatina", 
      'S-BIOG-937-958-959' = "B02Ib_21C_achatina"),
    course.urls = c(
    ...
    course.starts = c(
      'S-BIOG-015' = "2021-11-03 13:00:00"),
    course.ends = c(
      'S-BIOG-015' = "2021-11-15 23:59:59"),
    toc = "Utilisation de la régression linéaire (achatina)")
```

```{r, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("B02Ga_urchin", part = NULL,
    ...
    course.starts = c(
      'S-BIOG-015' = "2021-11-04 13:00:00"),
    course.ends = c(
      'S-BIOG-015' = "2021-11-15 23:59:59"),
