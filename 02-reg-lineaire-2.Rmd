...
if (exists("assignation"))
  assignation("B02Ga_anscombe", part = NULL,
    url = "https://github.com/BioDataScience-Course/B02Ga_anscombe",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/Rfdvbqw2", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/9EQCVg1n"),
    toc = "Quartet d’Anscombe")
```

## Régression linéaire multiple 

Dans le cas de la régression linéaire simple, nous considèrions le modèle statistique suivant (avec $\epsilon$ représentant les résidus, terme statistique dans l'équation)\ :
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B02Gb_achatina", part = NULL,
    url = "https://github.com/BioDataScience-Course/B02Gb_achatina",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/IIpgV7Mc", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/jGUT4KnU"),
    toc = "Utilisation de la régression linéaire (travail individuel sur achatina)")
```

```{r, echo=FALSE, results='asis'}
if (exists("assignation2"))
  assignation2("B02Gc_urchin", part = NULL,
    ...
    toc = "Utilisation la régression linéaire (travail en binôme sur urchin)")
```
