...
if (exists("assignation"))
  assignation("B07Ia_acp_afc", part = "I",
    url = "https://github.com/BioDataScience-Course/B07Ia_acp_afc",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/m_pli-r3", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/S1-5OdW8"),
    toc = "Analyse en composantes principales et l'analyse factorielle des correspondances.")
```
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B07Ia_acp_afc", part = "II",
    url = "https://github.com/BioDataScience-Course/B07Ia_acp_afc",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/m_pli-r3", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/S1-5OdW8"),
...
Il est possible de réaliser des choses plus complexes\ ! On peut naturellement chaîner tout cela avec le pipe `%>.%`, ou combiner les requêtes comme on veut. Rien n'est fait avant de `collect()`er les résultats.
...
if (exists("assignation2"))
  assignation2("B07Ga_doubs", part = NULL,
    url = "https://github.com/BioDataScience-Course/B07Ga_doubs",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/g/4NGpmS18", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/g/d9LfHBOF"),
    toc = "Etude écologique sur le Doubs")
```

## Récapitulatif des exercices

Ce module 7 vous a permis de découvrir 2 méthodes très utilisées dans les statistiques exploratoires (ACP et AFC). Ce module vous a également permit de découvrir l'utilisation des bases de données. 
