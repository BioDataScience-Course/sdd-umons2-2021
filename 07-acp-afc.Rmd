...
if (exists("assignment"))
  assignment("B07Ia_acp_afc", part = "I",
    ...
    course.ids = c(
      'S-BIOG-015' = "B07Ia_21M_acp_afc", 
      'S-BIOG-937-958-959' = "B07Ia_21C_acp_afc"),
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/...", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-015' = !"{W[26]+1} 08:00:00"),
    course.ends = c(
      'S-BIOG-015' = !"{W[28]+1} 23:59:59"),
    term = "Q2", level = 3,
...
```{r assign_B07Ga_doubs, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("B07Ga_doubs", part = NULL,
    url = "https://github.com/BioDataScience-Course/B07Ga_doubs",
    course.ids = c(
      'S-BIOG-015' = "B07Ga_21M_doubs", 
      'S-BIOG-937-958-959' = "B07Ga_21C_doubs"),
    course.urls = c(
