...
Consacrez un petit quart d'heure dans la SciViews Box nouvelle mouture pour repérer les nouvelles icônes dans le Dock et dans le menu `Applications`. Vous retrouverez R et RStudio, mais dans des version plus récentes qui apportent également leur lot de nouveautés (recherchez par exemple le nouvel onglet **Tutorial** dans RStudio). 

Une fois la nouvelle SciViews Box fonctionnelle sur votre ordinateur, vous allez réaliser une séance d'exercices couvrant les points essentiels des notions abordées dans le livre [science des données biologiques partie 1](https://wp.sciviews.org/sdd-umons), histoire de rafraîchir vos connaissances de l'an dernier. 
...
if (exists("assignation"))
  assignation("B01Ga_reglin1", part = NULL,
    url = "https://github.com/BioDataScience-Course/B01Ga_reglin1",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/o40tVOh8", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/u1SbQgxf"),
