...
Outre les outils, ce cours s'appuie sur des notions  que nous avons déjà abordé dans le cours de [science des données biologiques partie 1]( `r paste(learnitdown$baseurl, "sdd-umons", sep = "/")` ) comme la réalisation de graphiques variées, l'analyse de la variance ou encore les associations entre les variables. 
