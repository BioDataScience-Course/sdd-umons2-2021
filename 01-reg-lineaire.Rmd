...
<!-- PhG - Attention: cette assignation GitHub (même le template) n'existe pas encore ! Elle est placée ici pour mémoire et pour concrétisation peut-être plus tard. Cet exercice a été réalisé individuellement et via Wooclap en réalité en 2020-2021. Il s'agit de B01Wb_residus. Mais je voudrais transformer cela plutôt en un mini-challenge ou un projet GitHub Classroom par paires à l'avenir. -->

```{r, echo=FALSE, results='asis'}
if (exists("assignation2"))
  assignation2("B01Ga_residus", part = NULL,
