...
Toutes les questions relatives aux exercices sont à poser dans les issues GitHub dédiées à ce cours. L'assignation GitHub classroom ci-dessous vous permet de rejoindre cet espace de discussion.
...
Une fois que vous avez rejoint l'équipe `B21`, il n'est plus nécessaire d'utiliser cette assignation. Vous pouvez retrouver directement ce dépôt via la bannière du site.
