...
Toutes les questions relatives aux exercices sont à poser dans les issues GitHub dédiées à ce cours. Le lien GitHub Classroom ci-dessous vous permet de rejoindre cet espace de discussion.
...
if (exists("assignment2"))
  assignment2("B00Ga_issues", part = NULL, clone = FALSE,
    ...
    course.ids = c(
      'S-BIOG-015' = "B00Ga_21M_issues",
      'S-BIOG-937-958-959' = "B00Ga_21C_issues"),
    course.urls = c(
...
Une fois que vous avez rejoint l'équipe `B21`, il n'est plus nécessaire d'utiliser le lien GitHub Classroom vers ces issues. Vous pouvez retrouver directement ce dépôt via la bannière du site.
