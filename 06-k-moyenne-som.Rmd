...
if (exists("assignation"))
  assignation("B06Ia_fish_market", part = "I",
    url = "https://github.com/BioDataScience-Course/B06Ia_fish_market",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/CPLjQ1Mb", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/_YKeOJ4S"),
    toc = "Analyse multivarée sur 7 poissons couramment pêchés.")
```
...
```{r}
chart(veg_mds, labels = veg$station)
```
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B06Ia_fish_market", part = "II",
    url = "https://github.com/BioDataScience-Course/B06Ia_fish_market",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/CPLjQ1Mb", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/_YKeOJ4S"),
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B06Ia_fish_market", part = "III",
    url = "https://github.com/BioDataScience-Course/B06Ia_fish_market",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/CPLjQ1Mb", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/_YKeOJ4S"),
