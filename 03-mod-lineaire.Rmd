...
if (exists("assignation"))
  assignation("B02Gc_urchin", part = NULL,
    url = "https://github.com/BioDataScience-Course/B02G_urchin",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/g/foTtdgC5", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/g/5nzpamBh"),
...
```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B03Ga_ovocyte", part = NULL,
    url = "https://github.com/BioDataScience-Course/B03Ga_ovocyte",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/YSuLd7wZ", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/QwLCXKbY"),
    toc = "Exercices pratiques cadrés sur le modèle linéaire avec ovocyte")
```

```{r, echo=FALSE, results='asis'}
if (exists("assignation"))
  assignation("B03Gb_human", part = NULL,
    url = "https://github.com/BioDataScience-Course/B03Gb_human",
    course.urls = c(
      'S-BIOG-015' = "https://classroom.github.com/a/_6XKUpEM", 
      'S-BIOG-937-958-959' = "https://classroom.github.com/a/lwuZuRGJ"),
    toc = "Exercices pratiques libres sur le modèle linéaire avec human")
```
