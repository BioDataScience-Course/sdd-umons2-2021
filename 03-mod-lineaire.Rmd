...
if (exists("assignment2"))
  assignment2("B03Ga_urchin", part = "II",
    ...
    toc = "Modèle linéaire avec urchin (suite)",
    n = 2)
```
...
if (exists("assignment2"))
  assignment2("B03Gb_human", part = NULL,
    ...
    course.ids = c(
      'S-BIOG-015' = !"B03Gb_{YY}M_human", 
      'S-BIOG-937-958-959' = !"B03Gb_{YY}C_human"),
    course.urls = c(
    ...
    course.ends = c(
      'S-BIOG-015' = !"{W[15]+5} 23:59:59"),
    term = "Q1", level = 4, n = 2,
    toc = "Modèle linéaire simple et généralisé (human)")
```
