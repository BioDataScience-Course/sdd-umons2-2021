...
if (exists("assignation"))
  assignation("B04Ia_speed_reaction", part = NULL,
    url = "https://github.com/BioDataScience-Course/B04Ia_speed-reaction",
    course.urls = c(
...
if (exists("assignation2"))
  assignation2("B04Gb_bacterial_growth", part = NULL,
